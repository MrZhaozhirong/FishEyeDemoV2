...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode){
        ...
        if (shaderObjectId == 0){
            Log.e(TAG,"FBI Warning! Could not create new shader, glGetError:"+glGetError());
            return 0;
        }
        ...
        if(compileStatus[0] == 0){
            ...
            Log.e(TAG,"FBI Warning! Compilation of shader failed, glGetError:"+glGetError());
            return 0;
        }
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId){
        ...
        if (programObjectId == 0){
            Log.e(TAG,"FBI Warning! Could not create new program, glGetError:"+glGetError());
            return 0;
        }
        ...
        if(linkStatus[0] == 0){
            ...
            Log.e(TAG,"FBI Warning! Linking of program failed, glGetError:"+glGetError());
            return 0;
        }
