...
/**
 * Created by zzr on 2017/12/5.
 */

public class PanoTemplateSphereShaderProgram extends ShaderProgram {

    private final static String pano_template_sphere_vs =
            ...
            "\n" +
            "void main() {\n" +
            "    v_textureCoordinate.x = texCoord.x;\n" +
            "    v_textureCoordinate.y = 1.0 - texCoord.y;\n" +
            "    gl_Position = modelViewProjectionMatrix * position;\n" +
            "}";

    private final static String pano_template_fs =
    ...
    public PanoTemplateSphereShaderProgram() {
        super(pano_template_sphere_vs, pano_template_fs);

        mPositionLoc = GLES20.glGetAttribLocation(programId, "position");
        mTexCoordLoc = GLES20.glGetAttribLocation(programId, "texCoord");
        mMVPMatrixLoc = GLES20.glGetUniformLocation(programId, "modelViewProjectionMatrix");
